public class AkunBankStruktural {

    public static void setorTunai(double[] saldo, int indeksNasabah, double jumlah) {
        saldo[indeksNasabah] += jumlah;
        System.out.println("Setor tunai berhasil. Saldo " + namaNasabah[indeksNasabah] + " bertambah " + jumlah);
    }

    public static void tarikTunai(double[] saldo, int indeksNasabah, double jumlah) {
    ...
    public static void main(String[] args) {
        ...
        setorTunai(saldo, 0, 500000); // Andi setor 500000
        tarikTunai(saldo, 1, 200000); // Budi tarik 200000
